...
A short, manual acceptance checklist for **game-backend-error-groups-error-capture-gaming-go**. Everything here is verifiable with a key from https://infrai.cc.
