...
> Design notes for **game-backend-error-groups-error-capture-gaming-go** — a runnable go example that Classify and capture grouped failures from player assets, live events, and moderation queues.
...
- **Feature code** — the actual task: gaming error tracking.
